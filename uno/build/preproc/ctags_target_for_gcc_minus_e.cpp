# 1 "/home/gomofob/Projects/Arduino/UNO/UNO.ino"
// ArduinoISP
...
# 40 "/home/gomofob/Projects/Arduino/UNO/UNO.ino" 2
...
# 66 "/home/gomofob/Projects/Arduino/UNO/UNO.ino"
...
# 89 "/home/gomofob/Projects/Arduino/UNO/UNO.ino"
// HOODLOADER2 means running sketches on the ATmega16U2 serial converter chips
// on Uno or Mega boards. We must use pins that are broken out:
# 100 "/home/gomofob/Projects/Arduino/UNO/UNO.ino"
// By default, use hardware SPI pins:
# 113 "/home/gomofob/Projects/Arduino/UNO/UNO.ino"
...
# 158 "/home/gomofob/Projects/Arduino/UNO/UNO.ino" 2
# 229 "/home/gomofob/Projects/Arduino/UNO/UNO.ino"
void setup()
{
  Serial.begin(19200);
...
{
  digitalWrite(10 /* Use pin 10 to reset the target rather than SS*/, ((reset && rst_active_high) || (!reset && !rst_active_high)) ? 0x1 : 0x0);
}
...
void start_pmode()
{
  ...
  reset_target(true);
  pinMode(10 /* Use pin 10 to reset the target rather than SS*/, 0x1);
  SPI.begin();
...
void end_pmode()
{
  ...
  pinMode(SCK, 0x0);
  reset_target(false);
  pinMode(10 /* Use pin 10 to reset the target rather than SS*/, 0x0);
  pmode = 0;
}
